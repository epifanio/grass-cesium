...
class MapToolbar(BaseToolbar):
    ...
    def __init__(self, parent, toolSwitcher):
        ...
        ### start editing ###
        toolNum += 1
        choices.append(_("globe"))
        self.toolId['globe'] = toolNum
    ...
    def OnSelectTool(self, event):
        ...
        ###
        elif tool == self.toolId['globe']:
            self.ExitToolbars()
            self.parent.AddGlobe()
        ###
    ...
    def ExitToolbars(self):
        ...
        if self.parent._mgr.GetPane('globe') and self.parent._mgr.GetPane('globe').IsShown():
            self.parent.QuitGlobe()
